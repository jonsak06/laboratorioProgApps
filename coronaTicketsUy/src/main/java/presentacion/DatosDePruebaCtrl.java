...
"nuevas canciones ", 150,10,500,"https://twitter.com/PimpinelaNet",500,8,7,2020,pi,tl);
        ...
        em.getTransaction().begin();
        Registro r1 = new Registro(f1,co,9,4,2020,550);
        em.persist(r1);
        Registro r2 = new Registro(f1,sp,10,4,2020,550);
        em.persist(r2);
        Registro r3 = new Registro(f1,ar,12,4,2020,550);
        em.persist(r3);
        Registro r4 = new Registro(f2,ar,15,4,2020,550);
        em.persist(r4);
        Registro r5 = new Registro(f2,ap,20,4,2020,550);
        em.persist(r5);
        Registro r6 = new Registro(f2,co,25,4,2020,550);
        em.persist(r6);
        Registro r7 = new Registro(f2,ml,28,4,2020,550);
        em.persist(r7);
        Registro r8 = new Registro(f3,cb,16,4,2020,550);
        em.persist(r8);
        Registro r9 = new Registro(f3,co,15,5,2020,550);
        em.persist(r9);
        Registro r10 = new Registro(f3,ml,20,5,2020,550);
        em.persist(r10);
        Registro r11 = new Registro(f4,el,5,5,2020,750);
        em.persist(r11);
        Registro r12 = new Registro(f4,ew,10,5,2020,750);
        em.persist(r12);
        Registro r13 = new Registro(f4,sp,15,5,2020,750);
        em.persist(r13);
        Registro r14 = new Registro(f4,ap,20,5,2020,750);
        em.persist(r14);
        Registro r15 = new Registro(f5,gh,8,6,2020,750);
        em.persist(r15);
        Registro r16 = new Registro(f5,ew,16,6,2020,750);
        em.persist(r16);
        Registro r17 = new Registro(f5,ml,25,6,2020,750);
        em.persist(r17);
        Registro r18 = new Registro(f6,cb,5,7,2020,750);
        em.persist(r18);
        Registro r19 = new Registro(f6,sp,11,7,2020,750);
        em.persist(r19);
        Registro r20 = new Registro(f6,ar,18,7,2020,750);
        em.persist(r20);
        ...
        Registro r21 = new Registro(f7,ml,19,7,2020,0);
        r21.setCanjeados(cr21);
        em.persist(r21);
        Registro r22 = new Registro(f8,el,17,8,2020,800);
        em.persist(r22);
        Registro r23 = new Registro(f8,gh,20,8,2020,800);
        em.persist(r23);
        Registro r24 = new Registro(f8,ar,23,8,2020,800);
        em.persist(r24);
        ...
        Registro r25 = new Registro(f9,co,15,8,2020,0);
        r25.setCanjeados(cr25);
        em.persist(r25);
        Registro r26 = new Registro(f9,ew,26,8,2020,800);
        em.persist(r26);
        Registro r27 = new Registro(f10,ar,19,7,2020,0);
        ...
        em.persist(r27);
        Registro r28 = new Registro(f10,ap,16,8,2020,980);
        em.persist(r28);
        Registro r29 = new Registro(f10,ml,24,8,2020,980);
        em.persist(r29);
        Registro r30 = new Registro(f11,sp,1,8,2020,0);
        ...
        em.persist(r30);
        Registro r31 = new Registro(f11,gh,30,8,2020,980);
        em.persist(r31);
        Registro r32 = new Registro(f12,el,16,8,2020,980);
        em.persist(r32);
        Registro r33 = new Registro(f12,co,16,8,2020,980);
        em.persist(r33);
        Registro r34 = new Registro(f12,ew,1,9,2020,980);
        em.persist(r34);
        Registro r35 = new Registro(f12,sp,5,9,2020,980);
        em.persist(r35);
        Registro r36 = new Registro(f13,gh,16,8,2020,500);
        em.persist(r36);
        Registro r37 = new Registro(f13,cb,3,9,2020,500);
        em.persist(r37);
        Registro r38 = new Registro(f14,el,16,8,2020,500);
        em.persist(r38);
        Registro r39 = new Registro(f14,cb,6,9,2020,500);
        em.persist(r39);
        Registro r40 = new Registro(f15,co,1,9,2020,500);
        em.persist(r40);
        Registro r41 = new Registro(f16,sp,16,8,2020,450);
        em.persist(r41);
        Registro r42 = new Registro(f16,el,20,8,2020,450);
        em.persist(r42);
        Registro r43 = new Registro(f16,ap,31,8,2020,450);
        em.persist(r43);
        Registro r44 = new Registro(f17,ar,16,8,2020,450);
        em.persist(r44);
        Registro r45 = new Registro(f17,ap,20,8,2020,450);
        em.persist(r45);
        Registro r46 = new Registro(f17,co,2,9,2020,450);
        em.persist(r46);
        em.getTransaction().commit();
